        ...
        if entry_URL.get()!="" and pc_image_path=="" and size!="":
            ...
            try:
                ...
                if check.headers["content-type"] not in image_formats:
                    ...
                    image_path=''.join(entryurl.split("/")[-1])
                    open(filename, "wb").write(image_path.content)
                    secondwindow(generator(downstate, image_path, size), size)
...
def secondwindow(textimage, size):
    global rerun
    rerun=False
    ...
    ui2.geometry("650x400") #sizexxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
    ...
    text=Text(frame, width=50, height=10, bg="pink", bd=0) #sizexxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
    text.tag_configure("center", justify='center')
    text.insert("1.0", textimage)
