...
def generator(downstate, image_path, size):
    ...
    # operation to determine user size requirements, symbol - 9x18
    if size=="original":
        originwidth, originheight=image.size
        newwidth=originwidth//9
        newheight=originheight//19
    ...
    # operation to assign a character to grayscale
    ...
    return [text_image, newwidth, newheight]